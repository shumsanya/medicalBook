...
<?php $this->beginPage() ?>
    <!DOCTYPE html>
    <html lang="<?= Yii::$app->language ?>" class="h-100 perfect-scrollbar-on">
    <head>
        ...
        <div class="sidebar" data ="blue">
          ...
          -->
            <?php if (!Yii::$app->user->isGuest) { ?>
                ...
                <div class="sidebar-wrapper" id="div_menu">
                    <div class="logo">
                        <h4 >
                            Медицинская книга
                        </h4>
...
<!-- Fixed side setting menu -->
            <div class="fixed-plugin">
                <div class="dropdown show-dropdown">
                    <a href="#" data-toggle="dropdown">
                        <!--<i class="fa fa-cog fa-2x"> </i> отключено не работает СДН для авесоме -->
    ...
    <script>
        document.getElementById('btn').onclick = function() {
            document.getElementsByClassName('perfect-scrollbar-on').classList.add('nav-open');
        }
    </script>
